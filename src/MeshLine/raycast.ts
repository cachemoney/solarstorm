...
export function MeshLineRaycast(this: any, raycaster: THREE.Raycaster, intersects: THREE.Intersection[]) {
  ...
  if (index !== null) {
    ...
    for (let i = 0, l = indices.length - 1; i < l; i += step) {
      ...
      const precision = (raycaster.params as any).Line.threshold + (this.material.lineWidth * width) / 2
